...
aws_iot_core_ruta_archivo_llave="cert/casita-1.private.key"
mqtt_identificador_cliente="randal-casita"
mqtt_nombre_dispositivo="casita-1"
mqtt_tema_comando="comando"
mqtt_tema_telemetria="telemetria"
...
def conectar_con_aws_iot_core():
    ...
    global client, aws_iot_core_estado_conexion_activa
    ...
    client = mqtt5_client_builder.mtls_from_path(
        ...
        pri_key_filepath=aws_iot_core_ruta_archivo_llave,
    ...
    subscribe_packet=mqtt5.SubscribePacket(
        subscriptions = [
        mqtt5.Subscription(
            topic_filter = mqtt_tema_comando,
...
def on_lifecycle_attempting_connect_AWS(lifecycle_attempting_connect_data: mqtt5.LifecycleAttemptingConnectData):
    print("Lifecycle Connection Attempt\nConnecting to endpoint: '{}' with client ID'{}'".format(
        aws_iot_core_endpoint, mqtt_identificador_cliente))
